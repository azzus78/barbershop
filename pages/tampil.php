            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="" method="post">
                      <div class="controls">
                        <input type="text" name="datejadwal" class="form-control input-sm" id="tgllaporan" placeholder="Bulan" required="required">
                      </div>
                    </form> 
                </div>
        ...
        <form class="form-horizontal" role="form" action="prosesabsen.php" method="post">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Form Jadwal Kerja</h4>
                </div>
                <div class="modal-body">
                    <?php
                    ...
                    <div class="cobo" >
                        <table class="table table-bordered table-condensed table-hover" >
                                ...
                                <?php
                                    $no = '0';
                                    $result = mysqli_query($con,"SELECT * FROM pegawai where aktif='1' and visible='1'");
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                <td style="padding-left : 6px;">
                                                    <div class="divBox">
                                                        <input type="checkbox"  id="<?php echo "".$idpegawai."".$sh."";?>shift1" value="<?php echo "".$sh." 1 ".$jenengawal[0].""; ?>" name="<?php echo "".$sh."".$idpegawai."shift1"; ?>" />
                                                        <label for="<?php echo "".$idpegawai."".$sh."";?>shift1"></label>
                                                    </div>  
                                                </td>
                                                <td>
                                                    <div class="divBox">
                                                        <input type="checkbox" id="<?php echo "".$idpegawai."".$sh."";?>shift2" value="<?php echo "".$sh." 2 ".$jenengawal[0].""; ?>" name="<?php echo "".$sh."".$idpegawai."shift2"; ?>"/>
                                                        <label for="<?php echo "".$idpegawai."".$sh."";?>shift2"></label>
                                                    </div>          
                                                </td>
                                                <td>
                                                    <div class="divBox">
                                                        <input type="checkbox" id="<?php echo "".$idpegawai."".$sh."";?>shift3" value="<?php echo "".$sh." 3 ".$jenengawal[0].""; ?>" name="<?php echo "".$sh."".$idpegawai."shift3"; ?>" />
                                                        <label for="<?php echo "".$idpegawai."".$sh."";?>shift3"></label>
                                                    </div>  
                                                </td>
                                                <?php
                                                }
            ...
            <div class="panel-body">
                <div class="table-responsive table-bordered">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <?php
                        $no = '0';
                        $result = mysqli_query($con,"SELECT * FROM absensi where sudahpulang='0'");
                        while($row=mysqli_fetch_array($result))
                        {
                        $no++;
                        $datang = $row['datang'];
