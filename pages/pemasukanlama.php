...
$tgl=date('Y-m-d');
$query=mysqli_query($con,"INSERT INTO transaksi_temp(tgl) VALUES ('$tgl')");
    $result = mysqli_query($con,"SELECT max(idtransaksi_temp) as ID FROM transaksi_temp;");
    $transaksitemp = mysqli_fetch_array($result);
                                ...
                                <div class="col-md-12"> 
                                    <form class="form-horizontal" role="form" action="prosestransaksi.php" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4">
                                                <?php
                                                    $result=mysqli_query($con,"select MAX(RIGHT(nota,5)) as kd_max from transaksi"); 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-4 ">
                                                <select class ="form-control" data-placeholder="- Pilih Member -"  id="membertrx" name="member" required="required">
                                                    ...
                                                    <?php
                                                    $result=mysqli_query($con,"select * from member where visible='1'");
                                                    while($cp = mysqli_fetch_array($result))
                                                    {?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4 ">
                                                <?php
                                                    $result = mysqli_query($con,"SELECT sum(total) as tot_jasa FROM trxjasa_temp where transaksi_temp_idtransaksi_temp='$idtransaksitemp'");
                                                    $trxjasa_temp = mysqli_fetch_array($result);
                                                    mysqli_free_result($result);
                                                    $tot_jasa = $trxjasa_temp['tot_jasa'];

                                                    $result = mysqli_query($con,"SELECT sum(total) as tot_barang FROM trxbarang_temp where transaksi_temp_idtransaksi_temp='$idtransaksitemp'");
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                            <?php
                                                $result = mysqli_query($con,"SELECT transaksi_temp_idtransaksi_temp as ID FROM trxjasa_temp where transaksi_temp_idtransaksi_temp='$idtransaksitemp'");
                                                $trxjasa_temp = mysqli_fetch_array($result);
                                                mysqli_free_result($result);
                                                ...
                                                <div class="table-responsive table-bordered">
                                                    <table class="table table-striped">
                                                        ...
                                                        <?php
                                                            $no = '0';
                                                            $result = mysqli_query($con,"SELECT a.idtrxjasa_temp,b.nama,a.harga,a.qty,a.total,a.transaksi_temp_idtransaksi_temp 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                            <?php
                                                $result = mysqli_query($con,"SELECT transaksi_temp_idtransaksi_temp as ID FROM trxbarang_temp where transaksi_temp_idtransaksi_temp='$idtransaksitemp'");
                                                $trxjasa_temp = mysqli_fetch_array($result);
                                                mysqli_free_result($result);
                                                ...
                                                <div class="table-responsive table-bordered">
                                                    <table class="table table-striped">
                                                        ...
                                                        <?php
                                                            $no = '0';
                                                            $result = mysqli_query($con,"SELECT a.idtrxbarang_temp,b.nama,a.harga,a.qty,a.total,a.transaksi_temp_idtransaksi_temp 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8 col-md-offset-1">
                                        <select class ="form-control" name="barang" required="required">
                                            ...
                                            <?php
                                            $result=mysqli_query($con,"select * from barang where visible='1'");
                                            while($cp = mysqli_fetch_array($result))
                                            {?>
