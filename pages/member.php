            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <?php
                                $result=mysqli_query($con,"select MAX(RIGHT(nomember,4)) as kd_max from member"); 
            ...
            <div class="panel-body">
                <div class="table-respo">
                    <table class="table table-striped table-bordered table-hover" id="member">
                        ...
                        <?php
                        $no = '0';
                        $result = mysqli_query($con,"select*,YEAR(CURDATE()) - YEAR(tgl_lahir) AS umur from member where visible='1'");
