...
<div class="row">
    <div class="col-md-12"> 
        <div class="col-xs-8">
            <form class="form-horizontal" role="form" action="cashflow2" method="post">
...
<div class="row">
    <div class="col-lg-2 col-sm-offset-10">
        <a href="print/cashflow2xls.php?bulan=<?php echo $bulan; ?>&wulan=<?php echo $wulan; ?>&tahun=<?php echo $tahun; ?>" class="btn btn-outline btn-default"><i class="fa fa-print" style="font-size:150%;"></i> Save Excel</a>
    </div>
</div>
<br>    
    <div class="row">
                    ...
                    <div class="well">
                        <table>
                            <tr>
                                ...
                                <td>:</td>
                                <td align="right"><strong> <?php echo number_format($sumpendapatan,0,',','.');?></strong></td>
                            </tr>
                            <tr>
                                <td>Total Biaya</td>
                                <td>:</td>
                                <td align="right"><strong> <?php echo number_format($sumbiaya,0,',','.');?></strong></td>
                            </tr>
                            <tr>
                                <td>Total Pendapatan Bersih</td>
                                <td>:</td>
                                <td align="right"><strong> <?php echo number_format($sumbersih,0,',','.');?></strong></td>
                            </tr>
                        </table>
                    </div>
                </div>
