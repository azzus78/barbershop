...
<table border="0">
  ...
  <tr>
    <?php 
        $result=mysqli_query($con,"SELECT * from transaksi order by idtransaksi desc limit 1");
  ...
  <?php 
  if (!empty($idmember)) { 
        $result=mysqli_query($con,"SELECT nama from member where idmember='$idmember'");
...
<?php
  if ($tot_trxjasa!='0') { 
     $result = mysqli_query($con,"SELECT c.nama,b.harga,b.qty,b.total FROM transaksi a inner join trxjasa b on a.idtransaksi=b.transaksi_idtransaksi
...
<?php
  if ($tot_trxbarang!='0') { 
     $result = mysqli_query($con,"SELECT c.nama,b.harga,b.qty,b.total FROM transaksi a inner join trxbarang b on a.idtransaksi=b.transaksi_idtransaksi
