...
<body>
        ...
        <table border='1'>
            ...
            <tbody>
                <?php
                    $no = '0';
                    $result = mysqli_query($con,"SELECT b.iddetail_pengeluaran,a.tgl,b.keterangan as ket,b.jenis,b.total,c.nama FROM pengeluaran a inner join detail_pengeluaran b 
