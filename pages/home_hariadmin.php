						...
						<tr>
							<td valign="top">
								<table border="0">
									...
									<tr>
										<?php
										$qry = "SELECT b.paket_idpaket as ada
									...
									<tr>
										<?php
							           	$result=mysqli_query($con,"SELECT tgl,sum(freepangkas) as freepangkas FROM freepangkas where day(tgl)='$day' and month(tgl)='$bulan' and year(tgl)='$tahun'");
								...
								<table border="0">
									<tr>
										<?php
							           	$result=mysqli_query($con,"SELECT b.barang_idbarang as ada
						...
						<tr>
							<td valign="top">
								<table border="0">
									...
									<tr>
										<?php
							           	$result=mysqli_query($con,"SELECT a.tgl as ada
								...
								<table border="0">
									...
									<tr>
										<?php
							           	$result=mysqli_query($con,"SELECT b.keterangan as ada
										...
										<?php
											$no = '0';
											$result = mysqli_query($con,"SELECT b.keterangan,b.total FROM pengeluaran a inner join detail_pengeluaran b on a.idpengeluaran=b.pengeluaran_idpengeluaran and b.biaya_idbiaya='16' and day(a.tgl)='$day' and month(a.tgl)='$bulan' and year(a.tgl)='$tahun' and a.shift='1'");
											$totallain = '0';
											while($row=mysqli_fetch_array($result))
											{
												?>
						...
						<tr>
							<td valign="top">
								<table border="0">
									...
									<tr>
										<?php
							           	$result=mysqli_query($con,"SELECT b.paket_idpaket as ada
													FROM transaksi a inner join trxjasa b on a.idtransaksi=b.transaksi_idtransaksi
													inner join paket c on b.paket_idpaket=c.idpaket
							...
							<td valign="top">
								...
								<table border="0">
									...
									<tr>
										...
										<?php
											$no = '0';
											$result = mysqli_query($con,"SELECT b.keterangan,b.total FROM pengeluaran a inner join detail_pengeluaran b on a.idpengeluaran=b.pengeluaran_idpengeluaran and b.biaya_idbiaya='16' and day(a.tgl)='$day' and month(a.tgl)='$bulan' and year(a.tgl)='$tahun' and a.shift='3'");
											$totallain = '0';
											while($row=mysqli_fetch_array($result))
											{
												?>
