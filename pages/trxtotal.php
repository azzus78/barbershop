...
if(isset($_POST['cari']))
{
    ...
    if (empty($tanggalawal) and empty($tanggalakhir)) {
        ...
        if (empty($idshift)) {
            $result=mysqli_query($con,"SELECT sum(a.tot_trxbarang) as tot_barang,sum(a.tot_trxjasa) as tot_jasa,sum(a.total) as tot_transaksi FROM transaksi a
            ...
            $result=mysqli_query($con,"SELECT a.idtransaksi,a.tgl,a.nota,a.tot_trxbarang,a.tot_trxjasa,a.total,a.shift,b.nama FROM transaksi a
                    left join member b on a.member_idmember=b.idmember where tgl='$tglakhir' ORDER BY a.nota");
        }else{
            $result=mysqli_query($con,"SELECT sum(a.tot_trxbarang) as tot_barang,sum(a.tot_trxjasa) as tot_jasa,sum(a.total) as tot_transaksi FROM transaksi a
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered table-condensed table-hover">
                                                        ...
                                                        <tbody>
                                                                <?php
                                                                    $no = '0';
                                                                    $result2 = mysqli_query($con,"SELECT c.nama,b.qty,b.harga,b.total FROM transaksi a inner join trxjasa b on a.idtransaksi=b.transaksi_idtransaksi and a.nota='$nota'
                                                                                            inner join paket c on b.paket_idpaket=c.idpaket");
                                                                    $record= mysqli_num_rows ($result2); 
                                                                ...
                                                                <?php
                                                                    $no=$record;
                                                                    $result2 = mysqli_query($con,"SELECT c.nama,b.qty,b.harga,b.total FROM transaksi a inner join trxbarang b on a.idtransaksi=b.transaksi_idtransaksi and a.nota='$nota'
