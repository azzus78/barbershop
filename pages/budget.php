...
date_default_timezone_set("Asia/Jakarta");
$tgl=date('Y-m-d');
$query=mysqli_query($con,"INSERT INTO budget_temp(tgl) VALUES ('$tgl')");
    $result = mysqli_query($con,"SELECT max(idbudget_temp) as ID FROM budget_temp;");
    $budgettemp = mysqli_fetch_array($result);
                    ...
                    <div class="form-group" style="display:none;" id="barisTetap">
                         <div class="col-sm-8 col-md-offset-2">
                            <select class ="form-control" name="idbiaya" id="idtetap" onchange="FilterGaji();">
                                ...
                                <?php
                                $result=mysqli_query($con,"SELECT * FROM biaya where tetap is not null and idbiaya <> 40 order by nama");
                ...
                <form class="form-horizontal" role="form" action="prosesbudget.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-xs-4 col-xs-offset-1 ">
                            <?php
                                $result=mysqli_query($con,"SELECT sum(total) as total FROM detail_budget_temp where budget_temp_idbudget_temp='$idbudgettemp'"); 
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                <?php
                                    $result = mysqli_query($con,"SELECT a.iddetail_budget_temp as ID, a.keterangan,a.total,a.jenis,b.nama 
                                    ...
                                    $detailbudget_temp = mysqli_fetch_array($result);
                                    mysqli_free_result($result);
                                    $testtetap = $detailbudget_temp['ID'] ?? null;
                                    if (!empty($testtetap)) {
                                ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                        $no = '0';
                                        $result = mysqli_query($con,"SELECT a.iddetail_budget_temp as ID,a.total,a.jenis,concat(b.nama,' ',a.keterangan) as nama FROM detail_budget_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya and b.tetap is not null and a.budget_temp_idbudget_temp='$idbudgettemp'");
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                    <?php
                                        ...
                                        $detailbudget_temp = mysqli_fetch_array($result);
                                        mysqli_free_result($result);
                                        $testperlengkapan = $detailbudget_temp['ID'] ?? null;;
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <?php
                                ...
                                $detailbudget_temp = mysqli_fetch_array($result);
                                mysqli_free_result($result);
                                $testbelanja = $detailbudget_temp['ID'] ?? null;;
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <?php
                                ...
                                $detailbudget_temp = mysqli_fetch_array($result);
                                mysqli_free_result($result);
                                $testlain = $detailbudget_temp['ID'] ?? null;;
                                if (!empty($testlain)) {
                            ?>
