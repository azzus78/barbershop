...
if (!isset($_GET['idpkt'])) {
    ...
    $baru='0';
    $kd_pkt = $_GET['idpkt'];
    $result = mysqli_query($con,"SELECT * FROM paket where idpaket='$kd_pkt'");
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">                           
                            ...
                            <select class ="form-control" data-placeholder="Service 1"  id="servicesatu" name="service1" required="required">
                                ...
                                <?php
                                $result=mysqli_query($con,"select * from jasa where visible='1'");
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-condensed table-hover">
                        ...
                        <?php
                        $no = '0';
                        $result = mysqli_query($con,"SELECT * from paket where visible='1' ORDER BY nama");
