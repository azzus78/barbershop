...
if (!isset($_GET['idpgw'])) {
    ...
    $baru='0';
    $kd_pgw = $_GET['idpgw'];
    $result = mysqli_query($con,"SELECT * FROM pegawai where idpegawai='$kd_pgw'");
...
if (!isset($_GET['iduser'])) {
    ...
    $baru='0';
    $kd_user = $_GET['iduser'];
    $result = mysqli_query($con,"SELECT * FROM user where iduser='$kd_user'");
                ...
                <div class="panel-body">
                    <div class="table-responsive table-bordered">
                        <table class="table table-striped table-bordered table-hover" id="pegawai">
                            ...
                            <?php
                            $no = '0';
                            $result = mysqli_query($con,"SELECT * from user where visible='1'");
                            while($row=mysqli_fetch_array($result))
                            {
                            $no++
                            ?>
