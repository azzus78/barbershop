                ...
                <tr>
                    ...
                    <?php
                        for ($x = 1; $x <= $jum_tgl; $x++) {
                            ...
                            $shift1=mysqli_query($con,"SELECT * FROM jadwal where nama='$nama' and day(tgl)='$x' and shift='1'");
                            ...
                            $shift2=mysqli_query($con,"SELECT * FROM jadwal where nama='$nama' and day(tgl)='$x' and shift='2'");
                            $data=mysqli_fetch_array($shift2);
                            if(!empty($data))
                            {
                            echo "<td style='background:#292933;'></td>";
                            }else{
                            ...
                            $shift3=mysqli_query($con,"SELECT * FROM jadwal where nama='$nama' and day(tgl)='$x' and shift='3'");
                            $data=mysqli_fetch_array($shift3);
                            if(!empty($data))
                            {
                            echo "<td style='background:#292933;'></td>";
                            }else{
