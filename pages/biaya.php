...
date_default_timezone_set("Asia/Jakarta");
$tgl=date('Y-m-d');
$query=mysqli_query($con,"INSERT INTO pengeluaran_temp(tgl) VALUES ('$tgl')");
    $result = mysqli_query($con,"SELECT max(idpengeluaran_temp) as ID FROM pengeluaran_temp;");
    $pengeluarantemp = mysqli_fetch_array($result);
...
<script type="text/javascript">
        ...
        if (ValueTetap ==2){
                document.getElementById("barisGaji").style.display = '';
...
<div class="row">
    <div class="col-lg-12" >
        <h3 class="page-header">Halaman Biaya </h3>
    </div>
    <!-- /.col-lg-12 -->
</div>
    ...
    <div class="col-lg-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body" >
                <form class="form-horizontal" role="form" action="prosesbiaya.php" method="post">
                    ...
                    <div class="form-group" style="display:none;" id="barisTetap">
                         <div class="col-sm-8 col-md-offset-2">
                            <select class ="form-control" name="idbiaya" id="idtetap" onchange="FilterGaji();">
                                ...
                                <?php
                                $result=mysqli_query($con,"SELECT * FROM biaya where tetap is not null and visible='1' order by nama");
                                while($cp = mysqli_fetch_array($result))
                                {?>
                    ...
                    <div class="form-group"  style="display:none;" id="barisGaji">
                         <div class="col-sm-8 col-md-offset-2">
                            <select class ="form-control" name="pegawai" id="pegawai" >
                                <option selected value="">Nama pegawai</option>
                                <?php
                                $result=mysqli_query($con,"SELECT * FROM pegawai where visible='1'");
                                while($cp = mysqli_fetch_array($result))
                                {?>
                    ...
                    <div class="form-group" style="display:none;" id="barisPerlengkapan">
                         <div class="col-sm-8 col-md-offset-2">
                            <select class ="form-control" name="idbiaya">
                                <option selected disabled value="">Pilih Biaya</option>
                                <?php
                                $result=mysqli_query($con,"SELECT * FROM biaya where perlengkapan is not null and visible='1' order by nama");
                                while($cp = mysqli_fetch_array($result))
                                {?>
                                <option value="<?php echo $cp['idbiaya']; ?>"><?php echo $cp['nama'] ; ?></option>
                                <?php
                    ...
                    <div class="form-group" style="display:none;" id="barisBelanja">
                         <div class="col-sm-8 col-md-offset-2">
                            <select class ="form-control" name="idbiaya">
                                <option selected disabled value="">Pilih Biaya</option>
                                <?php
                                $result=mysqli_query($con,"SELECT * FROM biaya where belanja is not null and visible='1' order by nama");
                                while($cp = mysqli_fetch_array($result))
                                {?>
                                <option value="<?php echo $cp['idbiaya']; ?>"><?php echo $cp['nama'] ; ?></option>
                                <?php
                    ...
                    <input type="hidden" name="proses" value="biaya">
                </form>
            </div>
            <!-- /.panel-body -->
        </div>
                ...
                <form class="form-horizontal" role="form" action="prosesbiaya.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-xs-4 col-xs-offset-1 ">
                            <?php
                                $result=mysqli_query($con,"SELECT sum(total) as total FROM detail_pengeluaran_temp where pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'"); 
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                <?php
                                    $result = mysqli_query($con,"SELECT a.iddetail_pengeluaran_temp as ID, a.keterangan,a.total,a.jenis,b.nama 
                                                            FROM detail_pengeluaran_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya
                                                            and b.tetap is not null and a.pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
                                    $detailpengeluaran_temp = mysqli_fetch_array($result);
                                    mysqli_free_result($result);
                                    $testtetap = $detailpengeluaran_temp['ID'] ?? null;
                                    if (!empty($testtetap)) {
                                ?>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                        $no = '0';
                                        $result = mysqli_query($con,"SELECT a.iddetail_pengeluaran_temp as ID,a.total,a.jenis,concat(b.nama,' ',a.keterangan) as nama FROM detail_pengeluaran_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya and b.tetap is not null and a.pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <A HREF="prosesbiaya.php?id=<?php echo $row['ID'] ?>&skac=<?php echo $idpengeluarantemp ; ?>&proses=delbiaya" onclick='return confirm("Hapus <?php echo $row['nama']?> ?")'>
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                    <?php
                                        $result = mysqli_query($con,"SELECT a.iddetail_pengeluaran_temp as ID, a.keterangan,a.total,a.jenis,b.nama 
                                                                FROM detail_pengeluaran_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya
                                                                and b.perlengkapan is not null and a.pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
                                        $detailpengeluaran_temp = mysqli_fetch_array($result);
                                        mysqli_free_result($result);
                                        $testperlengkapan = $detailpengeluaran_temp['ID'] ?? null;
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <?php
                                $result = mysqli_query($con,"SELECT a.iddetail_pengeluaran_temp as ID, a.keterangan,a.total,a.jenis,b.nama 
                                                        FROM detail_pengeluaran_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya
                                                        and b.belanja is not null and a.pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
                                $detailpengeluaran_temp = mysqli_fetch_array($result);
                                mysqli_free_result($result);
                                $testbelanja = $detailpengeluaran_temp['ID'] ?? null;
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <?php
                                $result = mysqli_query($con,"SELECT a.iddetail_pengeluaran_temp as ID, a.keterangan,a.total,a.jenis,b.nama 
                                                        FROM detail_pengeluaran_temp a inner join biaya b on a.biaya_idbiaya=b.idbiaya
                                                        and b.lain is not null and a.pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
                                $detailpengeluaran_temp = mysqli_fetch_array($result);
                                mysqli_free_result($result);
                                $testlain = $detailpengeluaran_temp['ID'] ?? null;
                                if (!empty($testlain)) {
                            ?>
                    ...
                    ?>
                    <input type="hidden" name="idpengeluarantemp" value="<?php echo $idpengeluarantemp; ?>">
                    <input type="hidden" name="proses" value="pengeluaran">
                </form>
            </div>
        </div>
    </div>
