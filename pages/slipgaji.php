...
<div class="">
    <?php
        $nomor = '0';
        //$result2 = mysqli_query($con,"SELECT * FROM pegawai where aktif='1' and visible='1'");
        $result2 = mysqli_query($con,"SELECT nama,level FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' group by a.nama");
							...
							<td valign="top">
								<table border="0">
									...
									<tr>
									  ...
									  <td width="25"></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(pokok) as pokok FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$pokok = mysqli_fetch_array($result);
									...
									<tr>
										...
										<td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(bonus) as bonus FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$bonus = mysqli_fetch_array($result);
										mysqli_free_result($result);
									...
									<tr>
										...
										<td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(overtime) as overtime FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$overtime = mysqli_fetch_array($result);
										mysqli_free_result($result);
			                        ...
			                        <tr>
			                          ...
			                          <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(makan) as makan FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$makan = mysqli_fetch_array($result);
										mysqli_free_result($result);
			                        ...
			                        <tr>
			                          ...
			                          <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(transport) as transport FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
			                        ...
			                        <tr>
			                          ...
			                          <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(pulsa) as pulsa FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$pulsa = mysqli_fetch_array($result);
										mysqli_free_result($result);
			                        ...
			                        <tr>
			                          ...
			                          <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(hariraya) as hariraya FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$hariraya = mysqli_fetch_array($result);
										mysqli_free_result($result);
			                        ...
			                        <tr>
			                          ...
			                          <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(kesehatan) as kesehatan FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$kesehatan = mysqli_fetch_array($result);
										mysqli_free_result($result);
                                    ...
                                    <tr>
                                      ...
                                      <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(nikah) as nikah FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$nikah = mysqli_fetch_array($result);
										mysqli_free_result($result);
                                    ...
                                    <tr>
                                      ...
                                      <td></td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(dukacita) as dukacita FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$dukacita = mysqli_fetch_array($result);
										mysqli_free_result($result);
									...
									<tr #919191>
									  ...
									  <td>&nbsp;</td>
									  <?php
										$result=mysqli_query($con,"SELECT sum(kasbon) as kasbon FROM gaji a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' and a.nama='$nama'");
										$kasbon = mysqli_fetch_array($result);
										mysqli_free_result($result);
