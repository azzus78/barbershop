		        ...
		        <div class="">
		                ...
		                <div class="">
		                    <table class="table table-striped table-bordered table-hover" id="fixed_header" style="table-layout: fixed;">
		                        ...
		                        <tbody>
			                        <?php
			                        $no = '0';
			                        $result = mysqli_query($con,"SELECT * FROM biaya where tetap='1' and idbiaya <> 40");
			                        while($row=mysqli_fetch_array($result))
			                        {
			                        $no++;
			                        $idbiaya = $row['idbiaya'];
			                        $nama = $row['nama'];
			                        	$resultbudget = mysqli_query($con,"SELECT a.iddetail_budget,a.iddetail_budget,sum(a.total) as total FROM detail_budget a inner join budget b on a.budget_idbudget=b.idbudget
											and a.biaya_idbiaya='$idbiaya' and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' group by a.biaya_idbiaya");
											$budget = mysqli_fetch_array($resultbudget);
											mysqli_free_result($resultbudget);
											$iddetail=$budget['iddetail_budget'] ?? null;
											$totalbudget=$budget['total'] ?? null;

			                        	$resultbiaya = mysqli_query($con,"SELECT sum(a.total) as total FROM detail_pengeluaran a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran
											and a.biaya_idbiaya='$idbiaya' and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' group by a.biaya_idbiaya");
											$biaya = mysqli_fetch_array($resultbiaya);
											mysqli_free_result($resultbiaya);
											$totalbiaya=$biaya['total'] ?? null; 				                        			                        	
		                    ...
		                    <table class="table table-striped table-bordered table-hover" id="fixed_header" style="table-layout: fixed;">
		                        ...
		                        <tbody>
			                        <?php
			                        $no = '0';
			                        $result = mysqli_query($con,"SELECT * FROM biaya where belanja='1'");
			                        while($row=mysqli_fetch_array($result))
			                        {
			                        $no++;
			                        $idbiaya = $row['idbiaya'];
			                        $nama = $row['nama'];
			                        	$resultbudget = mysqli_query($con,"SELECT a.iddetail_budget,sum(a.total) as total FROM detail_budget a inner join budget b on a.budget_idbudget=b.idbudget
											and a.biaya_idbiaya='$idbiaya' and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' group by a.biaya_idbiaya");
											$budget = mysqli_fetch_array($resultbudget);
											mysqli_free_result($resultbudget);
											$iddetail=$budget['iddetail_budget'] ?? null;
		                    ...
		                    <table class="table table-striped table-bordered table-hover" id="fixed_header" style="table-layout: fixed;">
		                        ...
		                        <tbody>
			                        <?php
			                        $no = '0';
			                        $result = mysqli_query($con,"SELECT * FROM biaya where lain='1'");
			                        while($row=mysqli_fetch_array($result))
			                        {
			                        $no++;
			                        $idbiaya = $row['idbiaya'];
		            ...
		            <div class="panel-body">
		                    <table class="table table-striped table-bordered table-hover" id="fixed_header" style="table-layout: fixed;">
		                        ...
		                        <tbody>
			                        <?php
			                        	...
			                        	$resultbudget = mysqli_query($con,"SELECT a.iddetail_budget,sum(a.total) as total FROM detail_budget a inner join budget b on a.budget_idbudget=b.idbudget and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' ");
											$budget = mysqli_fetch_array($resultbudget);
											mysqli_free_result($resultbudget);
											$iddetail=$budget['iddetail_budget'] ?? null;
											$totalbudget=$budget['total'] ?? null;
			                        	$resultbiaya = mysqli_query($con,"SELECT sum(a.total) as total FROM detail_pengeluaran a inner join pengeluaran b on a.pengeluaran_idpengeluaran=b.idpengeluaran and a.biaya_idbiaya <> 40 and month(b.tgl)='$bulan' and year(b.tgl)='$tahun' ");
											$biaya = mysqli_fetch_array($resultbiaya);
											mysqli_free_result($resultbiaya);
											$totalbiaya=$biaya['total'] ?? null; 
			                        ?>
		                    ...
		                    <table class="table table-striped table-bordered table-hover" id="fixed_header" style="table-layout: fixed;">
		                        ...
		                        <tbody>
			                        <?php
			                        	$resultjasa = mysqli_query($con,"SELECT sum(b.total) as totaljasa
											...
											$jasa = mysqli_fetch_array($resultjasa);
											mysqli_free_result($resultjasa);
											$totaljasa=$jasa['totaljasa'];

			                        	$resultbarang = mysqli_query($con,"SELECT sum(b.total) as totalbarang
											...
											mysqli_free_result($resultbarang);
		                ...
		                <div class="">
		                    <table class="table table-striped table-bordered table-hover" id="fixed_header" style="table-layout: fixed;">
		                        ...
		                        <tbody>
			                        <?php
			                        $no = '0';
			                        $result = mysqli_query($con,"SELECT * FROM biaya where perlengkapan='1'");
			                        while($row=mysqli_fetch_array($result))
			                        {
			                        $no++;
			                        $idbiaya = $row['idbiaya'];
