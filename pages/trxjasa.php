    ...
    <div class="form-group" style="">
        ...
        <div class="col-xs-2">
            <select class ="form-control" name="paket">
                ...
                <?php
                $result=mysqli_query($con,"select * from paket where visible='1'");
...
if(isset($_POST['cari']))
{
    ...
    if (empty($tanggalawal) and empty($tanggalakhir)) {
        ...
        if (empty($idpaket)) {
            $result=mysqli_query($con,"SELECT sum(a.qty) as qty,sum(a.total) as subtotal FROM trxjasa a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi inner join paket c on a.paket_idpaket=c.idpaket left join member d on d.idmember=b.member_idmember where tgl='$tglakhir'");
            $subtotal = mysqli_fetch_array($result);
            mysqli_free_result($result);
            $tot_qty=$subtotal['qty'];
            $tot_paket=$subtotal['subtotal'];
            $result=mysqli_query($con,"SELECT a.qty,a.harga,a.total,b.tgl,b.nota,c.nama,d.nama as member FROM trxjasa a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi inner join paket c on a.paket_idpaket=c.idpaket left join member d on d.idmember=b.member_idmember where tgl='$tglakhir' ORDER BY b.nota");
        }else{
            $result=mysqli_query($con,"SELECT sum(a.qty) as qty,sum(a.total) as subtotal FROM trxjasa a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi inner join paket c on a.paket_idpaket=c.idpaket left join member d on d.idmember=b.member_idmember where tgl='$tglakhir' and c.idpaket='$idpaket'");
            $subtotal = mysqli_fetch_array($result);
            mysqli_free_result($result);
            $tot_qty=$subtotal['qty'];
            $tot_paket=$subtotal['subtotal'];
        ...
        if (empty($idpaket)) {
            $result=mysqli_query($con,"SELECT sum(a.qty) as qty,sum(a.total) as subtotal FROM trxjasa a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi inner join paket c on a.paket_idpaket=c.idpaket left join member d on d.idmember=b.member_idmember where tgl between '$tglawal' and '$tglakhir'");
            $subtotal = mysqli_fetch_array($result);
            mysqli_free_result($result);
            $tot_qty=$subtotal['qty'];
            $tot_paket=$subtotal['subtotal'];
            ...
            $result=mysqli_query($con,"SELECT sum(a.qty) as qty,sum(a.total) as subtotal FROM trxjasa a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi inner join paket c on a.paket_idpaket=c.idpaket left join member d on d.idmember=b.member_idmember where tgl between '$tglawal' and '$tglakhir' and c.idpaket='$idpaket'");
            $subtotal = mysqli_fetch_array($result);
            mysqli_free_result($result);
            $tot_qty=$subtotal['qty'];
            $tot_paket=$subtotal['subtotal'];
                ...
                <div class="panel-body">
                    ...
                    <div class="well">
                        <?php
                            ...
                            $result=mysqli_query($con,"SELECT nama FROM paket where idpaket='$idpaket'");
