...
if(isset($_POST['cari']))
{
    ...
    if (empty($tanggalawal) and empty($tanggalakhir)) {
        ...
        if (empty($idbarang)) {
            $result=mysqli_query($con,"SELECT sum(a.qty) as qty,sum(a.total) as subtotal FROM trxbarang a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi
            ...
            $result=mysqli_query($con,"SELECT a.qty,a.harga,a.total,b.tgl,b.nota,c.nama,d.nama as member FROM trxbarang a inner join transaksi b on a.transaksi_idtransaksi=b.idtransaksi
                ...
                <div class="panel-body">
                    ...
                    <div class="well">
                        <?php
                            ...
                            $result=mysqli_query($con,"SELECT nama FROM barang where idbarang='$idbarang'");
