...
<div class="row">
    <?php
            ...
            $result=mysqli_query($con,"SELECT * FROM pegawai WHERE idpegawai='$idpegawai'");
                ...
                <form class="form-horizontal" role="form" action="prosesgaji.php" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-xs-4 col-xs-offset-1 ">
                            <?php
                                $result=mysqli_query($con,"SELECT sum(total) as total FROM gaji_temp where pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'"); 
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                                <?php
                                    $result = mysqli_query($con,"SELECT idgaji_temp as ID
                                                            FROM gaji_temp
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <?php
                                        $no = '0';
                                        $result = mysqli_query($con,"SELECT idgaji_temp as ID,total,jenis FROM gaji_temp p where pengeluaran_temp_idpengeluaran_temp='$idpengeluarantemp'");
