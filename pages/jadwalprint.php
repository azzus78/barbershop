                ...
                <tr>
                    ...
                    <?php
                        for ($x = 1; $x <= $jum_tgl; $x++) {
                            ...
                            $shift1=mysqli_query($con,"SELECT * FROM jadwal where nama='$nama' and day(tgl)='$x' and bulan='$bulan' and tahun='$tahun' and shift='1'");
                            ...
                            $shift2=mysqli_query($con,"SELECT * FROM jadwal where nama='$nama' and day(tgl)='$x' and bulan='$bulan' and tahun='$tahun' and shift='2'");
                            ...
                            $shift3=mysqli_query($con,"SELECT * FROM jadwal where nama='$nama' and day(tgl)='$x' and bulan='$bulan' and tahun='$tahun' and shift='3'");
